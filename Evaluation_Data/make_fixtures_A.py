...
EXTRA_HOSPITALS = [            # {"hospital_id", "name", "panel", "country"}
    {"hospital_id": "H-9012", "name": "Harbourview Medical Centre",
...
EXTRA_POLICIES = [             # {"policy_id", "product", "status", "start_date",
    ...
    {"policy_id": "POL-8012", "product": "Team Test Comprehensive", "status": "active",
     "start_date": "2026-01-01", "end_date": "2027-12-31",
     "annual_limit": 30000, "used_to_date": 1000, "exclusions": []},
    {"policy_id": "POL-8021", "product": "Team Test Boundary", "status": "active",
     "start_date": "2026-01-01", "end_date": "2026-12-31",
     "annual_limit": 6000, "used_to_date": 5800, "exclusions": []},
    {"policy_id": "POL-8023", "product": "Team Test Start Boundary", "status": "active",
     "start_date": "2026-09-01", "end_date": "2027-08-31",
     "annual_limit": 10000, "used_to_date": 1000, "exclusions": []},
    {"policy_id": "POL-8024", "product": "Team Test End Boundary", "status": "active",
     "start_date": "2025-09-17", "end_date": "2026-09-16",
     "annual_limit": 10000, "used_to_date": 1000, "exclusions": []},
    {"policy_id": "POL-8025", "product": "Team Test Duplicate Near-Miss", "status": "active",
     "start_date": "2026-01-01", "end_date": "2026-12-31",
     "annual_limit": 10000, "used_to_date": 1000, "exclusions": []},
    {"policy_id": "POL-8041", "product": "Team Test Multi-Exclusion", "status": "active",
     "start_date": "2026-01-01", "end_date": "2026-12-31",
     "annual_limit": 10000, "used_to_date": 1000,
     "exclusions": [
         {"code": "31255", "rule": "EX-14 cosmetic dermatology"},
         {"code": "47120", "rule": "EX-21 specified surgery exclusion"},
         {"code": "29881", "rule": "EX-22 arthroscopy exclusion"},
     ]},
    {"policy_id": "POL-8042", "product": "Team Test Preauthorisation Boundary",
     "status": "active", "start_date": "2026-01-01", "end_date": "2026-12-31",
     "annual_limit": 12000, "used_to_date": 1000, "exclusions": []},
    {"policy_id": "POL-8044", "product": "Team Test Aggregate Boundary", "status": "active",
     "start_date": "2026-01-01", "end_date": "2026-12-31",
     "annual_limit": 6000, "used_to_date": 5000, "exclusions": []},
]
EXTRA_MEMBERS = [              # {"member_id", "name", "policy_id", "join_date"}
    {"member_id": "M-7012", "name": "Test Member 7012", "policy_id": "POL-8012",
     "join_date": "2026-01-01"},
    {"member_id": "M-7021", "name": "Test Member 7021", "policy_id": "POL-8021",
     "join_date": "2026-01-01"},
    {"member_id": "M-7023", "name": "Test Member 7023", "policy_id": "POL-8023",
     "join_date": "2026-09-01"},
    {"member_id": "M-7024", "name": "Test Member 7024", "policy_id": "POL-8024",
     "join_date": "2025-09-17"},
    {"member_id": "M-7025", "name": "Test Member 7025", "policy_id": "POL-8025",
     "join_date": "2026-01-01"},
    {"member_id": "M-7041", "name": "Test Member 7041", "policy_id": "POL-8041",
     "join_date": "2026-01-01"},
    {"member_id": "M-7042", "name": "Test Member 7042", "policy_id": "POL-8042",
     "join_date": "2026-01-01"},
    {"member_id": "M-7044", "name": "Test Member 7044", "policy_id": "POL-8044",
     "join_date": "2026-01-01"},
]
EXTRA_PREAUTHORISATIONS = [    # {"preauth_id", "member_id", "procedure_code",
                               #  "valid_from", "valid_to"}
    {"preauth_id": "PA-9013", "member_id": "M-7012", "procedure_code": "27447",
     "valid_from": "2026-09-01", "valid_to": "2026-12-31"},
    {"preauth_id": "PA-9015", "member_id": "M-7012", "procedure_code": "62480",
     "valid_from": "2026-09-01", "valid_to": "2026-12-31"},
    {"preauth_id": "PA-9042", "member_id": "M-7042", "procedure_code": "27447",
     "valid_from": "2026-09-05", "valid_to": "2026-12-31"},
    {"preauth_id": "PA-9054", "member_id": "M-2214", "procedure_code": "27447",
...
EXTRA_CLAIMS = [               # {"claim_id", "member_id", "hospital_id",
    ...
    {"claim_id": "CLM-9002", "member_id": "M-6118", "hospital_id": "H-114",
     ...
     "narrative": "Routine consultation with a metabolic panel.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 175},
               {"code": "80053", "amount": 95}]},
    {"claim_id": "CLM-9003", "member_id": "M-2214", "hospital_id": "H-207",
     "date_of_service": "2026-09-19",
     "narrative": "Diagnostic MRI completed as scheduled.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "70553", "amount": 650}]},
    {"claim_id": "CLM-9004", "member_id": "M-5502", "hospital_id": "H-114",
     "date_of_service": "2026-09-21",
     "narrative": "Day colonoscopy with a routine metabolic panel.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "45378", "amount": 1120},
               {"code": "80053", "amount": 85}]},
    {"claim_id": "CLM-9005", "member_id": "M-3390", "hospital_id": "H-207",
     "date_of_service": "2026-09-22",
     "narrative": "Laparoscopic appendicectomy with an uncomplicated recovery.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "47120", "amount": 350}]},
    {"claim_id": "CLM-9012", "member_id": "M-7012", "hospital_id": "H-9012",
     "date_of_service": "2026-09-23",
     "narrative": "Routine consultation and blood test.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 200},
               {"code": "80053", "amount": 100}]},
    {"claim_id": "CLM-9013", "member_id": "M-7012", "hospital_id": "H-9012",
     "date_of_service": "2026-09-24",
     "narrative": "Planned total knee replacement.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "27447", "amount": 2500}]},
    {"claim_id": "CLM-9014", "member_id": "M-7012", "hospital_id": "H-9012",
     "date_of_service": "2026-09-25",
     "narrative": "Planned knee replacement with consultation and blood work.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "27447", "amount": 2500},
               {"code": "99213", "amount": 200},
               {"code": "80053", "amount": 100}]},
    {"claim_id": "CLM-9015", "member_id": "M-7012", "hospital_id": "H-9012",
     "date_of_service": "2026-09-26",
     "narrative": "Planned knee and spinal procedures with routine follow-up tests.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "27447", "amount": 2500},
               {"code": "62480", "amount": 2000},
               {"code": "99213", "amount": 200},
               {"code": "80053", "amount": 100}]},
    {"claim_id": "CLM-9021", "member_id": "M-7021", "hospital_id": "H-207",
     "date_of_service": "2026-09-18",
     "narrative": "Routine outpatient consultation.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 200}]},
    {"claim_id": "CLM-9023", "member_id": "M-7023", "hospital_id": "H-207",
     "date_of_service": "2026-09-01",
     "narrative": "Routine outpatient consultation on the first policy day.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 180}]},
    {"claim_id": "CLM-9024", "member_id": "M-7024", "hospital_id": "H-207",
     "date_of_service": "2026-09-16",
     "narrative": "Routine outpatient consultation on the final policy day.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 180}]},
    {"claim_id": "CLM-9025", "member_id": "M-7025", "hospital_id": "H-207",
     "date_of_service": "2026-09-10",
     "narrative": "Routine consultation; this submission has a corrected amount.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 181}]},
    {"claim_id": "CLM-9031", "member_id": "M-2214", "hospital_id": "H-114",
     "date_of_service": "2026-09-23",
     "narrative": "Appendicectomy with a separate cosmetic skin procedure.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "47120", "amount": 1400},
               {"code": "31255", "amount": 300}]},
    {"claim_id": "CLM-9032", "member_id": "M-2214", "hospital_id": "H-114",
     "date_of_service": "2026-09-24",
     "narrative": "Planned spinal fusion with appendicectomy and diagnostic imaging.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "62480", "amount": 1800},
               {"code": "47120", "amount": 1400},
               {"code": "70553", "amount": 650}]},
    {"claim_id": "CLM-9033", "member_id": "M-5502", "hospital_id": "H-330",
     "date_of_service": "2026-09-25",
     "narrative": "Appendicectomy and MRI at a non-panel hospital; paid directly.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "47120", "amount": 1400},
               {"code": "70553", "amount": 650}]},
    {"claim_id": "CLM-9034", "member_id": "M-2214", "hospital_id": "H-207",
     "date_of_service": "2026-09-26",
     "narrative": "Spinal fusion, colonoscopy and appendicectomy; all records attached.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "62480", "amount": 1800},
               {"code": "45378", "amount": 1100},
               {"code": "47120", "amount": 1400}]},
    {"claim_id": "CLM-9041", "member_id": "M-7041", "hospital_id": "H-114",
     "date_of_service": "2026-10-01",
     "narrative": "Consultation with three separately listed procedures.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "99213", "amount": 200},
               {"code": "31255", "amount": 300},
               {"code": "47120", "amount": 1400},
               {"code": "29881", "amount": 1900}]},
    {"claim_id": "CLM-9042", "member_id": "M-7042", "hospital_id": "H-207",
     "date_of_service": "2026-09-05",
     "narrative": "Planned knee replacement on the first authorised day.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "27447", "amount": 2500}]},
    {"claim_id": "CLM-9043", "member_id": "M-7042", "hospital_id": "H-207",
     "date_of_service": "2026-12-31",
     "narrative": "Planned knee replacement on the final authorised day.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "27447", "amount": 2500}]},
    {"claim_id": "CLM-9044", "member_id": "M-7044", "hospital_id": "H-207",
     "date_of_service": "2026-10-02",
     "narrative": "MRI and consultation with a combined cost equal to the remaining limit.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "70553", "amount": 650},
               {"code": "99213", "amount": 350}]},
    {"claim_id": "CLM-9045", "member_id": "M-5502", "hospital_id": "H-114",
     "date_of_service": "2026-10-03",
     "narrative": "Colonoscopy, MRI and follow-up consultation; bill attached.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "45378", "amount": 1100},
               {"code": "70553", "amount": 650},
               {"code": "99213", "amount": 200}]},
    {"claim_id": "CLM-9051", "member_id": "M-5502", "hospital_id": "H-207",
     "date_of_service": "2026-10-04",
     "narrative": "Routine outpatient consultation.",
     "documents": ["itemised_bill"],
     "lines": [{"code": "99213", "amount": 200}]},
    {"claim_id": "CLM-9053", "member_id": "M-7023", "hospital_id": "H-207",
     "date_of_service": "2026-09-20",
     "narrative": "Planned total knee replacement.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "27447", "amount": 2500}]},
    {"claim_id": "CLM-9054", "member_id": "M-2214", "hospital_id": "H-114",
     "date_of_service": "2026-11-10",
     "narrative": "Knee replacement, consultation and a separate cosmetic procedure.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "31255", "amount": 300},
               {"code": "99213", "amount": 200},
               {"code": "27447", "amount": 2500}]},
    {"claim_id": "CLM-9055", "member_id": "M-7041", "hospital_id": "H-114",
     "date_of_service": "2026-10-05",
     "narrative": "Three procedures submitted together for assessment.",
     "documents": ["itemised_bill", "discharge_summary"],
     "lines": [{"code": "31255", "amount": 300},
               {"code": "47120", "amount": 1400},
               {"code": "29881", "amount": 1900}]},
...
EXTRA_DECIDED = [              # {"claim_id", "member_id", "hospital_id",
    ...
    {"claim_id": "CLM-9020", "member_id": "M-7025", "hospital_id": "H-207",
     "date_of_service": "2026-09-10",
     "lines": [{"code": "99213", "amount": 180}],
     "decision": "approve_in_principle", "decided_on": "2026-09-12"},
    {"claim_id": "CLM-9050", "member_id": "M-5502", "hospital_id": "H-207",
     "date_of_service": "2026-10-04",
     "lines": [{"code": "80053", "amount": 200}],
     "decision": "approve_in_principle", "decided_on": "2026-10-06"},
]
